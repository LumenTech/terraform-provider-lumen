...
func NewMorpheusClient(apiUrl string, authUrl string) (client *MorpheusClient) {
...
func (client *MorpheusClient) SetAuthToken(authToken string) {
	client.AuthToken = authToken
}

// Clearing Lumen APIGee auth
func (client *MorpheusClient) ClearAuthToken() {
	client.AuthToken = ""
}

// Setting up credentials and api token for lumen API access
func (client *MorpheusClient) SetCredsAndTokens(
...
func (client *MorpheusClient) GenerateAuthToken() error {
	...
	var authResp *morpheus.AuthResponse
	// Converting resty response into local Response object
	authResp = &morpheus.AuthResponse{
...
func (client *MorpheusClient) Execute(req *morpheus.Request) (*morpheus.Response, error) {
	// The transient resty response object
...
func (client *MorpheusClient) Get(req *morpheus.Request) (*morpheus.Response, error) {
	req.Method = "GET"
	return client.Execute(req)
}

func (client *MorpheusClient) Post(req *morpheus.Request) (*morpheus.Response, error) {
	req.Method = "POST"
	return client.Execute(req)
}

func (client *MorpheusClient) Put(req *morpheus.Request) (*morpheus.Response, error) {
	req.Method = "PUT"
	return client.Execute(req)
}

func (client *MorpheusClient) Delete(req *morpheus.Request) (*morpheus.Response, error) {
	req.Method = "DELETE"
	return client.Execute(req)
}
